...
public class DashboardSpecificModel {

    public DashboardSpecificModel(){

    }
    public ArrayList<DashboardEntry> loadEntries(int type){
        ...
        if (type == DashboardSpecificFragment.TYPE_ANNOUNCEMENTS) {
